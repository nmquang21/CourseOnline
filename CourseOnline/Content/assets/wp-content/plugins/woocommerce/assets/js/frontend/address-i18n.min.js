    ...
    e(document.body).bind("country_to_state_changing", function(i, t, r) {
        ...
        e.each(p, function(i, t) {
            ...
            var d = e(i).find(".form-row"),
                ...
                r = 0;
            d.each(function() {
                e(this).data("priority") || e(this).data("priority", r + 1), r = e(this).data("priority")
            }), d.sort(function(a, i) {
                var d = e(a).data("priority"),
                    t = e(i).data("priority");
