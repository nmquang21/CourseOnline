    ...
    var r = {
        ...
        strengthMeter: function() {
            var e = s("form.register, form.checkout, form.edit-account, form.lost_reset_password"),
                t = s('button[type="submit"]', e),
                o = s("#reg_password, #account_password, #password_1", e),
                a = 1,
                d = o.val();
            r.includeMeter(e, o), a = r.checkPasswordStrength(e, o), d.length > 0 && a < wc_password_strength_meter_params.min_password_strength && !e.is("form.checkout") ? t.attr("disabled", "disabled").addClass("disabled") : t.removeAttr("disabled", "disabled").removeClass("disabled")
        },
        ...
        checkPasswordStrength: function(s, r) {
            var e = s.find(".woocommerce-password-strength"),
                ...
                d = "";
            switch (e.removeClass("short bad good strong"), t.remove(), a < wc_password_strength_meter_params.min_password_strength && (d = " - " + wc_password_strength_meter_params.i18n_password_error), a) {
                case 0:
